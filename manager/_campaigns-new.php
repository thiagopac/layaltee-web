   ...
   jQuery(document).ready(function() {
     ...
     var FormValidation = function () {
   		...
   		var handleValidation = function() {
                     ...
                     valCampaignLocalId = valLocalId;
                     valCampaignDeleted = "0";
                     ...
                     if(sessionStorage.getItem("BASE_URL")){
                   			var BASE_URL = sessionStorage.getItem("BASE_URL");
   									...
   									$.ajax({
   											...
   											dataType:"json",
   											async: true,
   											data: JSON.stringify({campaignLocalId: valCampaignLocalId, campaignTitle : valCampaignTitle, campaignMessage : valCampaignMessage, campaignDeleted : valCampaignDeleted}),
                            ...
                            //    window.location.replace("main.php?page=campaigns-list");
                            //  }
