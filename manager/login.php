            ...
            <div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
               <div class="m-login__container">
                  ...
                  <div class="m-login__signin">
                     ...
                     <form class="m-login__form m-form" id="formLogin" name="formLogin">
                        <div class="form-group m-form__group">
                           <input class="form-control m-input"  type="text" placeholder="Usuário" name="adminLogin" id="adminLogin" autocomplete="off">
                        </div>
                        <div class="form-group m-form__group">
                           <input class="form-control m-input m-login__form-input--last" type="password" placeholder="Senha" id="adminPassword" name="adminPassword">
                        </div>
...
<script>
   jQuery(document).ready(function() {
       ...
       if (window.location.hostname == "localhost"){
           sessionStorage.setItem("BASE_URL", window.location.protocol + "//" + window.location.hostname + "/loyaltee/");
       }else{
           sessionStorage.setItem("BASE_URL", window.location.protocol + "//" + window.location.hostname + "/");
       }
   		...
   		var handleValidation = function() {
   						...
   						form1.validate({
   								...
   								submitHandler: function (form) {
   									...
   									valAdminLogin = $("#adminLogin").val();
   									valAdminPassword = $("#adminPassword").val()
   									...
   									$.ajax({
   											url: BASE_URL+'manager/webapi/admin/login',
   											type: 'POST',
   											contentType: 'application/json',
   											dataType:"json",
   											async: true,
   											data: JSON.stringify({adminLogin: valAdminLogin, adminPassword: valAdminPassword}),
                            ...
                            var local = {localId: admin.adminLocalId};
